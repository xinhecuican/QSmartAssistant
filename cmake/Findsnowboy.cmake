...
macro(_FIND_LIBRARY libname)
    if(NOT ${LIB_NAME}_${libname}_LIBRARY)
        ...
        NAMES ${libname} 
        HINTS ${${LIB_NAME}_ROOT_DIR}/lib /usr/local/lib)
        list(APPEND ${LIB_NAME}_LIBRARY ${${LIB_NAME}_${libname}_LIBRARY})
    endif()
endmacro(_FIND_LIBRARY)
_FIND_INCLUDE(snowboy-detect.h)
_FIND_LIBRARY(snowboy-detect)
_FIND_LIBRARY(atlas)
_FIND_LIBRARY(lapack_atlas)
_FIND_LIBRARY(cblas)
_FIND_LIBRARY(f77blas)
