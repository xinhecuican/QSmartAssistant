...
# _FIND_LIBRARY(kaldi-native-fbank-core)
_FIND_LIBRARY(onnxruntime)
_FIND_LIBRARY(sherpa-onnx-c-api)
# _FIND_LIBRARY(sherpa-onnx-core)
# _FIND_LIBRARY(piper_phonemize)
# _FIND_LIBRARY(sherpa-onnx-fst)
# _FIND_LIBRARY(sherpa-onnx-kaldifst-core)
# _FIND_LIBRARY(sherpa-onnx-portaudio)
# _FIND_LIBRARY(ucd)
