...
- [x] 支持porcupine,openwakeword,duilite三大唤醒引擎，可以自由定制唤醒词。支持cobra,fvad,silero,duilite四大vad引擎。搭配webrtc和speex，可以精确唤醒并降低误唤醒率。
- [x] 支持流式ASR和TTS
...
见[安装教程](https://github.com/xinhecuican/lowpower-robot/wiki/%E5%AE%89%E8%A3%85)
