...
DuiliteVad::DuiliteVad(QObject *parent)
    ...
    file.close();
    int ret = ((int (*)(char *))lib.resolve("duilite_library_load"))(
        loginData.data());
    if (ret) {
    ...
    vad = ((struct duilite_vad * (*)(char *, duilite_callback, void *))
               lib.resolve("duilite_vad_new"))(resData, vadCallback, this);
    ...
    std::string paramS = params.arg(duiliteConfig.value("wakeword").toString())
                             ...
                             .toStdString();
    startFunc = ((int (*)(struct duilite_vad *, char *))lib.resolve(
        "duilite_vad_start"));
    stopFunc = ((int (*)(struct duilite_vad *))lib.resolve("duilite_vad_stop"));
    feedFunc = (int (*)(struct duilite_vad *, char *, int))lib.resolve(
        "duilite_vad_feed");
    undetectTimer->disconnect(undetectTimer, &QTimer::timeout, nullptr,
                              nullptr);
...
int DuiliteVad::getChunkSize() { return chunkSize; }

void DuiliteVad::startDetect(bool isResponse) {
